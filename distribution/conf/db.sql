...
-- ----------------------------
-- Table structure for m_pan_file
-- ----------------------------
DROP TABLE IF EXISTS `m_pan_file`;

CREATE TABLE `m_pan_file`
(
...
-- ----------------------------
-- Table structure for m_pan_share
-- ----------------------------
DROP TABLE IF EXISTS `m_pan_share`;
CREATE TABLE `m_pan_share`
(
...
-- ----------------------------
-- Table structure for m_pan_share_file
-- ----------------------------
DROP TABLE IF EXISTS `m_pan_share_file`;
CREATE TABLE `m_pan_share_file`
(
...
-- ----------------------------
-- Table structure for m_pan_user
-- ----------------------------
DROP TABLE IF EXISTS `m_pan_user`;
CREATE TABLE `m_pan_user`
(
...
-- ----------------------------
-- Table structure for m_pan_user_file
-- ----------------------------
DROP TABLE IF EXISTS `m_pan_user_file`;
CREATE TABLE `m_pan_user_file`
(
...
-- ----------------------------
-- Table structure for m_pan_user_search_history
-- ----------------------------
DROP TABLE IF EXISTS `m_pan_user_search_history`;
CREATE TABLE `m_pan_user_search_history`
(
    `id`             bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `user_id`        bigint(0) NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for m_pan_file_chunk
-- ----------------------------

DROP TABLE IF EXISTS `m_pan_file_chunk`;
CREATE TABLE `m_pan_file_chunk`
(
...
-- ----------------------------
-- Table structure for m_pan_error_log
-- ----------------------------

DROP TABLE IF EXISTS `m_pan_error_log`;
CREATE TABLE `m_pan_error_log`
(
    `id`          bigint                           NOT NULL AUTO_INCREMENT COMMENT '主键',
