...
/**
 * 用户搜索历史表
 * @TableName m_pan_user_search_history
 */
@TableName(value ="m_pan_user_search_history")
@Data
public class MPanUserSearchHistory implements Serializable {
    /**
     * 主键
     */
    ...
    public boolean equals(Object that) {
        ...
        MPanUserSearchHistory other = (MPanUserSearchHistory) that;
